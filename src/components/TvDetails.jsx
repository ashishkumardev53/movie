    ...
    >
      ...
      <div className="w-full flex ">
        ...
        <div className="content ml-[10%] text-white">
          ...
          <h1 className="text-2xl mt-1">tv Translated :</h1>
      ...
      <h1 className="text-white text-3xl font-bold mt-5">Seasons</h1>
      <div className="w-[100%] flex overflow-y-hidden mb-5 p-5 ">
        {info.detail.seasons.length > 0 ? (
          info.detail.seasons.map((s, i) => (
            <div className="w-[20vh] mr-[10%]">
              <img
                key={i}
                className="shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[30v] min-w-[14vw] object-cover"
      ...
      {/* part-5  recomendetations and similarity stuf */}
      <hr className="text-zinc-500 mt-10 mb-5 h-[2px]" />
